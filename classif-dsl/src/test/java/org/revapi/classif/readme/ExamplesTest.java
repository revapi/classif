...
//
//        Map<Element, TestResult> res = test(env, "@Anno(a = 'x') ^;", Tester.Hierarchy.builder()
//                .add(example1)
//                .build());
//
...
//
//        Map<Element, TestResult> res = test(env, "!@Anno ^;", Hierarchy.builder()
//                .add(annotated)
//                .add(notAnnotated)
//                .build());
//
...
//
//        Map<Element, TestResult> res = test(env, "type ^**./.*Private/ {}", Hierarchy.builder()
//                .add(notMatched)
//                .add(matched)
//                .build());
//
...
//    }
// TODO THE BELOW DONT WORK AT ALL
//    @Test
//    void example8() {
