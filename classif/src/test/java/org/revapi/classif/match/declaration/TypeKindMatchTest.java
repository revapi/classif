...
class TypeKindMatchTest {
    ...
    void test() {
        ...
        DeclarationMatch classes = new TypeKindMatch(false, TypeKind.fromString("class"));
        DeclarationMatch interfaces = new TypeKindMatch(false, TypeKind.fromString("interface"));
        DeclarationMatch enums = new TypeKindMatch(false, TypeKind.fromString("enum"));
        DeclarationMatch annos = new TypeKindMatch(false, TypeKind.fromString("@interface"));
